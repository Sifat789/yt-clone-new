    ...
    return (
        ...
        <div className='ml-5  '>
            ...
            <div className='w-full mt- pb-1 space-y-2 border-solid border-b-2 border-gray-200'>
                ...
                <button className='flex space-x-4 py-1 pl-2 rounded-t-md pb-2 hover:bg-gray-100 w-full items-center border-solid border-b-2 border-gray-200'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <div className='w-full mt-6 pb-1 space-y-2 border-solid border-b-2 border-gray-200'>
                <h2 className='font-semibold ml-2 text-lg'>Explore</h2>
            ...
            <div className='w-2/12 ml-4 mt-6 pb-1 space-y-2'>
                <p>
...
export default LeftSideBarHeavy